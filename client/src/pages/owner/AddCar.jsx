...
const AddCar = () => {
  ...
  return (
    <div className='px-4 py-10 md:px-10 flex-1'>
      ...
      <div className='grid lg:grid-cols-[minmax(0,36rem)_20rem] gap-8 items-start'>
      <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
        ...
        {/* Car Description */}
         ...
         <div className='flex flex-col w-full'>
            ...
            <input type="url" placeholder="https://example.com/car.glb" className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.model3d} onChange={e=> setCar({...car, model3d: e.target.value})}/>
            <p className='text-xs text-gray-400 mt-1'>Optional .glb or .gltf link for interactive 3D preview.</p>
          </div>
      ...
      <aside className='mt-6 border border-borderColor rounded-md p-5 text-sm text-gray-600 bg-white shadow-sm'>
        <h2 className='text-lg font-medium text-gray-800'>Listing Boosters</h2>
        <p className='mt-1 text-gray-500'>Use these as customer-facing selling points in your description.</p>
        <div className='space-y-3 mt-5'>
          {['Verified owner badge', 'Sanitized before pickup', 'Fast pickup available', 'License check required', 'Coupon eligible', 'Interactive 3D preview'].map((item)=> (
        ...
        <div className='mt-5 bg-light rounded-md p-4'>
          <p className='font-medium text-gray-800'>Unique tip</p>
          <p className='mt-1'>Mention ideal trips, luggage space, pickup timing, and special features to improve bookings.</p>
        </div>
      </aside>
      </div>

      <div className='mt-8 max-w-6xl'>
        <div className='rounded-md overflow-hidden border border-borderColor bg-white shadow-sm'>
