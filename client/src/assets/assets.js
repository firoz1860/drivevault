...
export const menuLinks = [
    ...
    { name: "Rental Suite", path: "/rental-suite" },
    { name: "Mobility Hub", path: "/mobility-hub" },
]
...
export const ownerMenuLinks = [
    ...
    { name: "Operations", path: "/owner/operations", icon: dashboardIcon, coloredIcon: dashboardIconColored },
]
...
export const dummyCarData = [
    {
        ...
        "model": "X5",
        "image": car_image1,
        "model3d": "https://threejs.org/examples/models/gltf/ferrari.glb",
        "year": 2006,
        "category": "SUV",
        "seating_capacity": 4,
        "fuel_type": "Hybrid",
    ...
    },
    {
        ...
        "model": "Neo 6",
        "image": car_image4,
        "model3d": "https://modelviewer.dev/shared-assets/models/CesiumMan.glb",
        "year": 2022,
        "category": "Sedan",
        "seating_capacity": 2,
        "fuel_type": "Diesel",
